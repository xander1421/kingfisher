...
| D4 | **not in this queue and not in `specs/`** — §7 LOOP-DONE requires D1–D6 as written specs; D1+/D2/D3/D5 exist, D4 and D6 were never seeded | OPEN — blocks LOOP-DONE |
| D6 | the discipline standard is *cited* everywhere ("the D6 standard", §5) but exists only as MISSION_LOOP §5 prose, not as `specs/D6_*.md` | OPEN — blocks LOOP-DONE |
